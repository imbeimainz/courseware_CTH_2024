...
Is the newly defined sleep quality associated with age groups?
...
Load the packages `tidyverse`, `exactRankTests` and `pseudorank` <!-- and the data sets contained in Nonparametric.RData into your R environment. -->
