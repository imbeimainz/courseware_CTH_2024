...
```{r ex1-hypothesis-test1, exercise=TRUE, exercise.lines=5}
...
```{r ex2-vis-data2, exercise=TRUE, exercise.lines=5}
...
```{r ex2-hypothesis-test2, exercise=TRUE, exercise.lines=5}
...
```{r ex3-two-ind-samples-2, exercise=TRUE, exercise.lines=5}
# Generate plot
...
```{r ex3-two-ind-samples-3, exercise=TRUE, exercise.lines=5}
# t-test
...
```{r ex3-two-ind-samples-4, exercise=TRUE, exercise.lines=5}
# WMW test
...
```{r ex3-more-than-two-ind-samples-2, exercise=TRUE, exercise.lines=5}
# Generate plot
# Simple base R version:
...
```{r ex3-more-than-two-ind-samples-3, exercise=TRUE, exercise.lines=5}
# Kruskal-Wallis test
...
```{r ex3-paired-samples-2, exercise=TRUE, exercise.lines=5}
...
```{r ex3-paired-samples-3, exercise=TRUE, exercise.lines=5}
...
```{r ex3-paired-samples-4, exercise=TRUE, exercise.lines=5}
...
```{r ex3-paired-samples-5, exercise=TRUE, exercise.lines=5}
...
```{r ex3-paired-samples-6, exercise=TRUE, exercise.lines=5}
...
```{r ex4-multiple-testing-1, exercise=TRUE, exercise.lines=5}
...
```{r ex4-multiple-testing-2, exercise=TRUE, exercise.lines=5}
